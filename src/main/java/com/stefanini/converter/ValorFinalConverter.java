...
@FacesConverter(value = "valorInicialConverter")
public class ValorFinalConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) throws ConverterException {
		...
		if (value != null && !value.equals("0")) {
			...
			FacesMessage message = new FacesMessage("Valor Final é Obrigatório!");
