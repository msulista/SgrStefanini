...
@FacesConverter(value = "valorHoraConverter")
public class valorHoraConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) throws ConverterException {
		...
		if (value != null && !value.equals("0")) {
			...
			FacesMessage message = new FacesMessage("Valor Hora é Obrigatório!");
